...
<html lang="ru">
    <head>
      ...
      arenda avto, стоимость аренды машины, израиль прокат автомобилей, съем машины Израиле, аренда авто, прокат машины, сьем автомобиля,автомобиль,  машина Израиле, дешевый прокат автомобиля" />
        <meta  name="description"  content="аренда прокат Kia Picanto в Израиле, аренда прокат автомобиля в Израиле, эконом класс и семейные машины, микроавтобусы и минивэны 7-8-9 мест" />
...
<!--                  <a href="single.html">	-->
                    ...
                    <img src="../images/car_key_vastama.jpeg" alt="прокат аренда Kia Picanto в Израиле начиная с 25$" class="img-responsive"/>
