...
<html lang="ru">
    <head>
        ...
        <title>аренда прокат Peugeot 107 в Израиле | rentalcarsisrael.com</title>
<meta name="keywords" content="машина прокат, машина прокат Израиле, аренда машины Израиль, avto prokat, prokat mashin, auto arenda, прокат аренда машин, где можно взять машину напрокат, заказать машину, аренда иномарок, 
      arenda avto, стоимость аренды машины, израиль прокат автомобилей, съем машины Израиле, аренда авто, прокат машины, сьем автомобиля,автомобиль,  машина Израиле, дешевый прокат автомобиля" />
        <meta  name="description"  content="аренда прокат Peugeot 107 в Израиле, аренда прокат автомобиля в Израиле, эконом класс и семейные машины, микроавтобусы и минивэны 7-8-9 мест | rentalcarsisrael.com" />
        <meta property="fb:app_id" content="1322511981092474" />
        <meta property="og:type" content="website" />
        <meta property="og:locale" content="ru_RU" />       
        <meta property="og:url" content="http://www.rentalcarsisrael.com/ru/catC_Peugeot_107_4seats_automatic.php" />
        ...
        <meta property="og:description" content="аренда прокат Peugeot 107 в Израиле, аренда прокат автомобиля в Израиле, эконом класс и семейные машины, микроавтобусы и минивэны 7-8-9 мест"/>
...
<link rel="shortcut icon" href="favicon.ico">
    ...
    <?php include("../seo_stat"); ?>
        ...
        <div class="container-fluid">
              <h1>Прокат аренда Peugeot 107 в Израиле начиная с 25$</h1>
              <div class="row">
                <div class="col-sm-6 biseller-column" >
<!--                  <a href="single.html">	-->

                    <img src="../images/car_key_vastama.jpeg" alt="прокат аренда Peugeot 107 в Израиле начиная с 25$" class="img-responsive"/>
                    <span class="price"><img src="../m/images/viber_whatsapp_icon.png" alt="прокат аренда Peugeot 107 в Израиле начиная с 25$" /> +972-58-7710101</span>
<!--                  </a>-->
...
<h4 style="color:green; font-weight: lighter;">Нет штрафов за изменение или отмену заказа, нет скрытых платежей</h4>
                ...
                <h5>или свяжитесь с нами по <img src="../m/images/viber_whatsapp_icon.png" alt="прокат аренда Peugeot 107 в Израиле начиная с 25$" /> +972-58-771-0101</h5>
...
<?php include("__rentalconditions.html"); ?>  
                ...
                <div class="col-sm-6 ad-info">
                  <h2>Категория аренды проката: C 
                      <br>Peugeot 107 или подобная</h2>
                    ...
                    <a href="catC_Toyota_Aygo_4seats_automatic.php">Toyota_Aygo</a>
                      и другие
