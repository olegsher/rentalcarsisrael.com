...
<html lang="ru">
    <head>
        ...
        <title>аренда прокат Skoda Citigo в Израиле | rentalcarsisrael.com</title>
<meta name="keywords" content="машина прокат, машина прокат Израиле, аренда машины Израиль, avto prokat, prokat mashin, auto arenda, прокат аренда машин, где можно взять машину напрокат, заказать машину, аренда иномарок, 
      ...
      сьем автомобиля,автомобиль,  машина Израиле, дешевый прокат автомобиля" />
        ...
        <meta property="og:title" content="Прокат автомобиля в Израиле, пассажирский микроавтобус и минивэн 9 мест, 
              автоматическая коробка передач начиная с 25$"/>
        <meta property="og:description" content="аренда прокат Skoda Citigo в Израиле, аренда прокат автомобиля в Израиле, эконом класс и семейные машины, микроавтобусы и минивэны 7-8-9 мест"/>
...
<link rel="shortcut icon" href="favicon.ico">
    ...
    <?php include("../seo_stat"); ?>
        ...
        <div class="container-fluid">
              <h1>Прокат аренда Skoda Citigo в Израиле начиная с 25$</h1>
              <div class="row">
                <div class="col-sm-6 biseller-column" >
<!--                  <a href="single.html">	-->

                    <img src="../images/car_key_vastama.jpeg" alt="прокат аренда Skoda Citigo в Израиле начиная с 25$" class="img-responsive"/>
                    <span class="price"><img src="../m/images/viber_whatsapp_icon.png" alt="прокат аренда Skoda Citigo в Израиле начиная с 25$" /> +972-58-7710101</span>
<!--                  </a>-->
...
<h4 style="color:green; font-weight: lighter;">Нет штрафов за изменение или отмену заказа, нет скрытых платежей</h4>
                ...
                <h5>или свяжитесь с нами по <img src="../m/images/viber_whatsapp_icon.png" alt="прокат аренда Skoda Citigo в Израиле начиная с 25$" /> +972-58-771-0101</h5>
...
<?php include("__rentalconditions.html"); ?>  
                ...
                <div class="col-sm-6 ad-info">
                  <h2>Категория аренды проката: C 
                      <br>Skoda Citigo или подобная</h2>
