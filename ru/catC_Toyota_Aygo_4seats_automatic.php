...
<link rel="shortcut icon" href="favicon.ico">
    ...
    <?php include("../seo_stat"); ?>
        ...
        <div class="container-fluid">
              <h1>Прокат аренда Toyota Aygo в Израиле начиная с 25$</h1>
              <div class="row">
                <div class="col-sm-6 biseller-column" >
<!--                  <a href="single.html">	-->

                    <img src="../images/car_key_vastama.jpeg" alt="прокат аренда Toyota Aygo в Израиле начиная с 25$" class="img-responsive"/>
                    <span class="price"><img src="../m/images/viber_whatsapp_icon.png" alt="прокат аренда Toyota Aygo в Израиле начиная с 25$" /> +972-58-7710101</span>
<!--                  </a>-->
...
<h4 style="color:green; font-weight: lighter;">Нет штрафов за изменение или отмену заказа, нет скрытых платежей</h4>
                ...
                <h5>или свяжитесь с нами по <img src="../m/images/viber_whatsapp_icon.png" alt="прокат аренда Toyota Aygo в Израиле начиная с 25$" /> +972-58-771-0101</h5>
...
<?php include("__rentalconditions.html"); ?>  
                ...
                <div class="col-sm-6 ad-info">
                  <h2>Категория аренды проката: C 
                      <br>Toyota Aygo или подобная</h2>
