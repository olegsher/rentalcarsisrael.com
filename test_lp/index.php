				...
				<ul class="form-bxslider unstyled">
					...
					<li>
						<div class="list-forstart fin_1">
							...
							<ul class='ul-list-slider Open-sansR'>
								<li>Cras Congue Ipsum</li>
								<li>Vivamus Odio Arcu, Fringilla - 300 ui</li>
								<li>In Fermentum Cursus Felis</li>
								<li>Proin at Scelerisque Enim</li>
							</ul>
						</div>
					...
					<li>
						<div class="list-forstart fin_1">
							...
							<ul class='gray-list-slider Open-sansR'>
								<li>24/6 Tristique Adipiscing</li>
								<li>Nullam Ornare Ligula a Erat Dignissim</li>
								<li>Curabitur Tempor Sapien Sem</li>
								<li>Vivamus Egestas Magna</li>
							</ul>
						</div>
